...
```
tq-pools/
├── public/                 ← static frontend (deploy this folder)
│   ├── index.html          ← home
...
```bash
# Serve the public folder for a quick look
cd tq-pools/public
python3 -m http.server 8080
# then open http://localhost:8080
```

The pages will render but without Supabase keys, the booking flow falls back to its
in-memory service list and form submits will be intercepted in the console. To go
live, follow `docs/DEPLOY.md`.
...
| Hosting      | Vercel / Netlify / Cloudflare Pages (any static) |
